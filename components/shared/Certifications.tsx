      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl shadow-xl shadow-gray-300/30 p-8 sm:p-12">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8">
            <Image src="/assets/images/certificates/certificate2.png" alt="TripAdvisor 2016 Certificate of Excellence" width={96} height={96} className="object-contain w-20 h-20 md:w-24 md:h-24" />
            <Image src="/assets/images/certificates/certificate3.png" alt="TripAdvisor 2017 Certificate of Excellence" width={96} height={96} className="object-contain w-20 h-20 md:w-24 md:h-24" />
            <Image src="/assets/images/certificates/certificate4.png" alt="TripAdvisor 2018 Certificate of Excellence" width={96} height={96} className="object-contain w-20 h-20 md:w-24 md:h-24" />
            <Image src="/assets/images/certificates/certificate5.png" alt="TripAdvisor 2019 Certificate of Excellence" width={96} height={96} className="object-contain w-20 h-20 md:w-24 md:h-24" />
            <div className="bg-white rounded-xl p-2 sm:p-3 shadow-sm">
              <Image src="/assets/images/certificates/certificate6.webp" alt="Travelers Choice 2023" width={88} height={88} className="object-contain w-16 h-16 sm:w-20 sm:h-20" />
            </div>
            ...
            <Image src="/assets/images/certificates/2025PersonalisedTravelWinnerLogo2631.webp" alt="Personalised Travel Winner 2025" width={96} height={96} className="object-contain w-20 h-20 md:w-24 md:h-24" />
          </div>
        </div>
      </div>
    </section>
