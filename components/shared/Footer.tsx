...
export function Footer() {
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/80">
                ...
                <li>
                  <LocaleLink href="/sitemap-page" className="hover:text-[#14b8a6] transition-colors flex items-center gap-2">
                    <span className="text-[#14b8a6]">›</span>
                    {t('footer.sitemap')}
                  </LocaleLink>
                </li>
      ...
      <div className="bg-[#0a0f1a] border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 text-center text-sm space-y-2">
          <p className="text-white">© {new Date().getFullYear()} Copyright Phuket Sailing Co. Ltd.</p>
          <div className="flex items-center justify-center gap-3">
            <LocaleLink href="/impressum" className="text-white/70 hover:text-white underline transition-colors">
              {t('footer.impressum')}
            </LocaleLink>
            <span className="text-white/30">|</span>
            <LocaleLink href="/sitemap-page" className="text-white/70 hover:text-white underline transition-colors">
              Sitemap
            </LocaleLink>
          </div>
        </div>
