...
export function CTASection() {
  return (
    <section className="py-16 md:py-20 bg-gradient-to-r from-sky-900 via-blue-900 to-cyan-900 mx-4 md:mx-4 lg:mx-4 xl:mx-8 rounded-3xl shadow-2xl border-4 border-amber-400 my-12">
      <div className="container mx-auto px-6 md:px-8">
        <div className="text-center">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <a
              href="tel:+66612345623"
              className="group flex flex-col items-center p-5 bg-white/10 backdrop-blur-sm rounded-2xl hover:bg-white/20 transition-all border border-white/20"
            >
            ...
            <a
              ...
              className="group flex flex-col items-center p-5 bg-white/10 backdrop-blur-sm rounded-2xl hover:bg-white/20 transition-all border border-white/20"
            >
              <div className="w-12 h-12 bg-green-400 rounded-full flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
